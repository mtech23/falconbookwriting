...
import { bookMarketingImg2, eBookSEOImg2 } from "../../asserts/images";
...
const EBookSEO = () => {
  return (
    <>
      <UserLayout>
        <InnerHero
          innerheroclass="eBookSEOBg"
          title="Get Your eBook Discovered With"
          subtitle=" Ebook SEO Expertise"
        ...
        <Section2
          ...
          title="The Perfect Place For Ebook SEO Service Unrivaled Ebook SEO Expertise  "
