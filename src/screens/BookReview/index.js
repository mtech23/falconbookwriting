...
import { bookMarketingImg2, bookReviewImg2 } from "../../asserts/images";
...
const BookReview = () => {
  return (
    <>
      <UserLayout>
        <InnerHero
          innerheroclass="bookReviewBg"
          title="Professional Book Review"
        ...
        <Section2
          ...
          title="Why One Should Consider   "
          subtitle=" Book Review Template? "
